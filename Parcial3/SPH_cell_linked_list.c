/*Parcial 3: Astrostrofisica computacional
Melanie Andrea Munoz Chvarria
"Busqueda de vecinos con linked list"*/
...
int main(int argc, char *argv[])
{
  ...
  double Lx, Ly, dx, dy; //separacion entre los elementos de la malla y separacion entre los puntos de la simulacion
